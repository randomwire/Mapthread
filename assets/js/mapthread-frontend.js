            ...
            options: {
                ...
                plugins: {
                    ...
                    tooltip: {
                        ...
                        titleFont: { family: "'Helvetica Neue', Helvetica, Arial, sans-serif", size: 11, weight: 'normal' },
                        bodyFont: { family: "'Helvetica Neue', Helvetica, Arial, sans-serif", size: 13, weight: '600' },
