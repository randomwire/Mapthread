<?php
/**
 * Title: Pathway Two-Column Layout
 * Slug: pathway/two-column-layout
 * Categories: pathway, layout
 * Description: Pre-configured two-column layout for Pathway stories with sticky map
 * Keywords: pathway, map, columns, layout, story
...
?>
<!-- wp:columns {"align":"wide","style":{"spacing":{"gap":"var:preset|spacing|50"}}} -->
